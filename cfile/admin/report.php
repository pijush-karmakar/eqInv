  ...
  ">
	...
	<div id="right_content" >
        ...
        All Item Status Report</div>
             ...
             View Item Conditions Report & Print
              </div>
              <b>Select Item Condition : </b>
                <select class="btn btn-default btn-sm" id="report-choice">
                  <option value="all">All</option>
                  <option value="working">Working</option>
                  <option value="condemed">Condemed</option>
                </select>
                
                <button id="print-btn" type="button" class="btn btn-success btn-xs">
                PRINT
