				...
				<form class="form-horizontal" role="form" id="update-item-form">
					<input type="hidden" id="iID">
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
					    <label class="control-label col-sm-3">Model No.:</label>
					    <div class="col-sm-9"> 
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-9"> 
					      <textarea class="form-control item-des" name="item-des" disabled rows="4" cols="5">
					      </textarea>
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-9"> 
					      <input type="text" class="form-control item-amount" disabled placeholder="Enter Amount">
					    </div>
					  </div>

					  <div class="form-group">
					    <label class="control-label col-sm-3">Date Purchased:</label>
					    <div class="col-sm-9"> 
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3">Date Expire:</label>
					    <div class="col-sm-9"> 
					      <input type="text" class="form-control item-warranty" disabled placeholder="Enter Amount">
					    </div>
					  </div>

					   <div class="form-group">
					    <label class="control-label col-sm-3">Book Value:</label>
					    <div class="col-sm-9"> 
					      <input type="text" class="form-control item-value" disabled placeholder="Enter Amount">
					    </div>
					  </div>
