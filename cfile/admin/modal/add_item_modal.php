			...
			<div class="modal-body">
				<!-- main form -->
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="itemdes">Item Description:</label>
					    <div class="col-sm-9">
					     
					    <!--   <textarea class="form-control" name="itemdes" rows="4" cols="5">
					      </textarea> -->
					      <input type="text" class="itd form-control" id="itemdes" placeholder="Enter item des">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="warDate">Expired Date:</label>
					    <div class="col-sm-9"> 
					      <input type="date" class="form-control" id="warDate">
					    </div>
					  </div>

					  <div class="form-group">
					    <label class="control-label col-sm-3" for="valueDate">Book Value:</label>
					    <div class="col-sm-9"> 
					 ...
					 <!-- old cat pos -->
					  ...
					  <div class="form-group"> 
					    <div class="col-sm-offset-10 col-sm-2">
					      <button type="submit" id="btn-submit" value="add" class="btn btn-success btn-sm">Save
