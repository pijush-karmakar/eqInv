			...
			<div class="modal-body">
				<!-- main form -->
					...
					<input type="hidden" id="iID">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="itemdes-update">Item Description:</label>
					    <div class="col-sm-9">
					     
					      <!-- <textarea type="text" class="form-control" id="itemdes-update" name="itemdes" rows="4" cols="5">
					      </textarea> -->
					      <input type="text" class="form-control" id="itemdes-update" placeholder="Enter item des">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="warDate-update">Expire Date:</label>
					    <div class="col-sm-9"> 
					      <input type="date" class="form-control" id="warDate-update">
					    </div>
					  </div>

					  <div class="form-group">
					    <label class="control-label col-sm-3" for="valueDate-update">Book Value:</label>
					    <div class="col-sm-9"> 
					      <input type="date" class="form-control" id="valueDate-update">
					    </div>
					  </div>
				    ...
				    <div class="form-group">
					  ...
					  <div class="form-group"> 
					    <div class="col-sm-offset-10 col-sm-2">
					      <button type="submit" id="btn-update-submit" class="btn btn-success btn-sm">Save
