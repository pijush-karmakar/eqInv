...
class Employee extends Database implements iEmployee {
	...
	public function insert_employee($fN, $lN, $pos, $off, $type)
	{
		$un = $fN.'_'.$lN;
		...
		$sql = "INSERT INTO tbl_employee
				(emp_fname, emp_lname, pos_id, off_id, type_id, emp_un, emp_pass)
				VALUES(?, ?, ?, ?, ?, ?, ?);
				";
		return $this->insertRow($sql, [$fN, $lN, $pos, $off, $type, $un, $pass]);
	}
